...
func (x *CreteOrderRequest) GetCustomerId() int64 {
	if x != nil {
		return x.CustomerId
	}
	return 0
...
func (x *CreteOrderRequest) GetOrderItems() []*OrderItem {
	if x != nil {
		return x.OrderItems
	}
	return nil
...
func (x *CreateOrderResponse) GetTotalQuantity() int32 {
	if x != nil {
...
var file_order_order_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x61, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65,
	...
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x49, 0x64, 0x12, 0x2b, 0x0a, 0x0b, 0x6f, 0x72, 0x64,
	...
	0x79, 0x22, 0x78, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x74, 0x6f,
	0x74, 0x61, 0x6c, 0x51, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x32, 0x3d, 0x0a, 0x05, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x12, 0x34, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x12,
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x61, 0x6a, 0x65, 0x7a, 0x61, 0x6e,
	0x75, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2d, 0x6d, 0x69,
...
var file_order_order_proto_goTypes = []any{
	(*CreteOrderRequest)(nil),   // 0: CreteOrderRequest
	(*OrderItem)(nil),           // 1: OrderItem
	(*CreateOrderResponse)(nil), // 2: CreateOrderResponse
}
var file_order_order_proto_depIdxs = []int32{
	1, // 0: CreteOrderRequest.order_items:type_name -> OrderItem
	0, // 1: Order.Create:input_type -> CreteOrderRequest
